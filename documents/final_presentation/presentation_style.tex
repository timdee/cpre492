...
\graphicspath{ {../designed_document/pi_images/} {../design_document/images/} {../poster/images/} {images/} {camera/} }

% Common settings for all lectures in this course

\def\lecturename{Team May1612}
...
\setbeamertemplate{title page}
{
  ...
  \vskip1em
  {}
  %{\huge Remotely Connected Electric Field Generator \insertshortlecture\par}
  ...
  \fi%     
  \vskip1em\par
  Presented by \emph{\lecturename}\ on \insertdate\par
  \vskip0pt plus1filll
  \leftskip=0pt plus1fill\insertauthor\par
  \insertinstitute\vskip1em
}

%TODO set logo (Minnetronix?)
