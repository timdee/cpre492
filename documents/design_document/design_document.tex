...
%TODO discuss the complexity associated with making the phase shifts the same
%TODO potentailly list the transfer function of a single amplifier?
...
% insert summing amplifier picture
%\begin{center}
...
%TODO talk about how to connect the pi to a computer and interact with it
%TODO recommend that ssh be setup to control the pi remotely

\subsubsection{Place circuit controlling software on the Raspberry Pi}
%TODO picture of installing Rasbian.
%\begin{center}
